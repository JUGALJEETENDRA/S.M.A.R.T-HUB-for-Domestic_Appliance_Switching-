 /**********************************************************************************
 *  TITLE: WiFi + Bluetooth + Manual (Push Button) control 8 relays using ESP32 & Blynk | Realtime Feedback |
...
#define AUTH "PUT BLYNK TOKEN HERE"                 // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "PUT NAME HERE"             //Enter Wifi Name
#define WIFI_PASS "PUT PASS WORD HERE"         //Enter wifi Password
